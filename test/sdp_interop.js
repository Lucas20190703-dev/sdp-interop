...
QUnit.test('3-way-qhsense', function (assert) {

  var interop = new Interop();

  var playbook = JSON.parse(fs.readFileSync("test/3-way-qhsense/playbook.json"));
...
QUnit.test('2-way-qhsense', function (assert) {

  var interop = new Interop();

  var playbook = JSON.parse(fs.readFileSync("test/2-way-qhsense/playbook.json"));
